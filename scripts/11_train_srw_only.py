...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train YOLO with SRW only.")
...
def main() -> None:
    ...
    if args.saliency_provider != "saliency_head":
        raise SystemExit("SRW-only training currently supports only --saliency-provider saliency_head.")
    ...
    logger.info("Starting SRW-only training.")
